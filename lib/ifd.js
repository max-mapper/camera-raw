...
class IFD {
  ...
  get orientation() {
    return this.fields.get(274).value;
  }
  get samplesPerPixel() {
    return this.fields.get(277).value;
  }
  get rowsPerStrip() {
    return this.fields.get(278).value;
  }
  get stripByteCounts() {
    return alwaysArray(this.fields.get(279).value);
  }
  get minSampleValue() {
    return this.fields.get(280).value || 0;
  }
  get maxSampleValue() {
    var field = this.fields.get(281)
    return field ? field.value : Math.pow(2, this.bitsPerSample) - 1;
  }
  get xResolution() {
